...
let SoundScape = function(options = {}) {
  ...
  let fr = 60
    ...
    , uiControls
    , drawQ
    , url = audioPlayer.url // audioPlayer.urls[ Math.floor(Math.random() * audioPlayer.urls.length) ];
    , center = {}
    ;
  let themes = {
  ...
  */
  let AudioController = function() {
    ...
    let fft = new p5.FFT(0.8, bins) // default smoothing value 0.8
      , self = this;
